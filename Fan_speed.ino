...
// Uses Timer1/3/4/5 for each fan respectively as these are usually the 16-bit timers if the board has them
  ...
  #define OUT_PIN_0 5    // Any other non-important pin
  ...
  #define OUT_PIN_0 4  // Any other non-important pin

  #define IN_PIN_1  6  // INT1
  #define OUT_PIN_1 7  // Any other non-important pin
  ...
  #define OUT_PIN_2 9  // Any other non-important pin

  #define IN_PIN_3 19  // INT4
  #define OUT_PIN_3 11 // Any other non-important pin

#else
  // Define custom boards here
  //  https://www.arduino.cc/reference/en/language/functions/external-interrupts/attachinterrupt/
  // #define IN_PIN_0  ?  // INT0/1/2/3/... (A free hardware interrupt pin)
  // #define OUT_PIN_0 ?  // Any other non-important pin
...
#ifdef IN_PIN_2
    calculateOutputInterval(2);
#endif

#ifdef IN_PIN_3
    calculateOutputInterval(3);
#endif
}
